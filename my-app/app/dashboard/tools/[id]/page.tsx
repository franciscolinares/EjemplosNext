...
//de declara la constante de tipo funcion
const ToolOptions = () => {//el nombre tiene que iniciar en Mayuscula y debe ser CamelCase !!!!!!!
    ...
    return(//retorna un elemento JSX | (permite escribir código similar al HTML dentro de un archivo JavaScript)
      ...
      <div className="flex md:order-2">
        ...
        >
          ...
          <Dropdown.Item onClick={() => router.push("/perfil")}>
            Ir a perfil
          </Dropdown.Item>
          <Dropdown.Divider />
                      ...
                      item.options.map((dropItem, i) => {
                        return (
                          <Dropdown.Item
                            ...
                            className="hidden md:flex"
                            onClick={() => router.push(dropItem.href)}
                          >
                            {dropItem.title}
                          </Dropdown.Item>
                        );
